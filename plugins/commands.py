...
async def balance_cmd_handler(bot, message: Message):
    ...
    try:
        ...
        chrome_options.binary_location = os.environ.get("GOOGLE_CHROME_BIN", "/root/.apt/usr/bin/google-chrome")
        chrome_options.add_argument("--headless")
        chrome_options.add_argument("--disable-dev-shm-usage")
        chrome_options.add_argument("--no-sandbox")
        driver = webdriver.Chrome(executable_path=os.environ.get("CHROMEDRIVER_PATH", "/root/.chromedriver/bin/chromedriver"), chrome_options=chrome_options)
