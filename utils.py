...
async def get_me_button(user):
    ...
    buttons = []
    try:
        buttons = [[InlineKeyboardButton('Header Text', callback_data='ident'), InlineKeyboardButton('🚫 Click To Disable' if user["is_header_text"] else '✅ Click To Enable', callback_data=f'setgs#is_header_text#{not user["is_header_text"]}#{str(user_id)}')], [InlineKeyboardButton('Footer Text', callback_data='ident'), InlineKeyboardButton('🚫 Click To Disable' if user["is_footer_text"] else '✅ Click To Enable', callback_data=f'setgs#is_footer_text#{not user["is_footer_text"]}#{str(user_id)}')], [InlineKeyboardButton('Username', callback_data='ident'), InlineKeyboardButton('🚫 Click To Disable' if user["is_username"] else '✅ Click To Enable', callback_data=f'setgs#is_username#{not user["is_username"]}#{str(user_id)}')], [InlineKeyboardButton('Banner Image', callback_data='ident'), InlineKeyboardButton('🚫 Click To Disable' if user["is_banner_image"] else '✅ Click To Enable', callback_data=f'setgs#is_banner_image#{not user["is_banner_image"]}#{str(user_id)}')], [InlineKeyboardButton('Bitly Link', callback_data='ident'), InlineKeyboardButton('🚫 Click To Disable' if user["is_bitly_link"] else '✅ Click To Enable', callback_data=f'setgs#is_bitly_link#{not user["is_bitly_link"]}#{str(user_id)}')], [InlineKeyboardButton('Channel Link', callback_data='ident'), InlineKeyboardButton('🚫 Click To Disable' if user["is_pvt_link"] else '✅ Click To Enable', callback_data=f'setgs#is_pvt_link#{not user["is_pvt_link"]}#{str(user_id)}')],[InlineKeyboardButton('Hastag', callback_data='ident'), InlineKeyboardButton('🚫 Click To Disable' if user["is_hashtag"] else '✅ Click To Enable', callback_data=f'setgs#is_hashtag#{not user["is_hashtag"]}#{str(user_id)}')]]
    except Exception as e:
        print(e)
    return buttons
